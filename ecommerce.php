...
<head>
	...
	<meta name="description" content="Κατασκευή e-shop βασιζόμενη σε δοκιμασμένη λύση ετών. Η εμπειρία μας στο χώρο του e-commerce, καθώς και η ευελιξία των πλατφορμών αυτών συνθέτουν την πραγματικά άριστη λύση για τις ανάγκες λειτουργίας ενός e-shop." />
	<meta name="author" content="Spyros Mygdanis"/>
	
	<!--Meta tags gia Facebook-->
	<link rel="image_src" href="http://etherlogic.gr/img/placeholders/onlinemarketing.jpg" / ><!--poia photo trabaei-->
	<meta property="og:title" content="EtherLogic - E-Commerce" />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="http://etherlogic.gr/ecommerce.html" />
	<meta property="og:image" content="http://etherlogic.gr/img/placeholders/onlinemarketing.jpg" />
	<meta property="og:description" content="Κατασκευή e-shop βασιζόμενη σε δοκιμασμένη λύση ετών. Η εμπειρία μας στο χώρο του e-commerce, καθώς και η ευελιξία των πλατφορμών αυτών συνθέτουν την πραγματικά άριστη λύση για τις ανάγκες λειτουργίας ενός e-shop." />
...
<section id="content" class="container clearfix">
	...
	<section id="main">
		...
		<article class="entry single clearfix">
			...
			<a href="#" title="">
				<img src="img/placeholders/onlinemarketing.jpg" alt="" class="entry-image">
			</a>
			...
			<div class="entry-body">
				...
				<h6>E-Commerce</h6>
<p>Κατασκευή e-shop βασιζόμενη σε δοκιμασμένη λύση ετών. Η εμπειρία μας στο χώρο του e-commerce, καθώς και η ευελιξία των πλατφορμών αυτών συνθέτουν την πραγματικά άριστη λύση για τις ανάγκες λειτουργίας ενός e-shop.</p>
<p>Δίνοντας έμφαση στην ασφάλεια και χρησιμοποιώντας τα καλύτερα πρωτόκολλα, δημιουργούμε για εσάς και τους πελάτες σας έναν ασφαλή τόπο συναλλαγών επιτυγχάνοντας παράλληλα την ποικιλία στις συναλλαγές με τα περισσότερα πιστωτικά ιδρύματα και τράπεζες.</p>
<p>Ακολουθώντας τις πλέον λειτουργικές αρχές του User Experience Design και πάντα με έμφαση στην λεπτομέρεια, θα σχεδιάσουμε μαζί σας την εμφάνιση του ηλεκτρονικού σας καταστήματος ώστε βελτιστοποιήσουμε την εμπειρία των πελατών σας.</p>
 ...
 -->					<li><a href="mobileapps.html">Mobile Apps</a></li>
		...
		<div class="widget">
			...
			<h6 class="widget-title">Τελευταία Νέα</h6>
					...
					<?php query_posts('cat=10','showposts=2'); while(have_posts()) : ?>
