...
μετατρέποντας τους επισκέπτες σας σε πελάτες.<a id="test" href="img/wuc.jpg" class="single-image"></a></p>
		<p><ul class="check dotted">
			...
			<!--<span class='st_sharethis_large' displayText='ShareThis'></span>
				...
				<span class='st_fblike_large' displayText='Facebook Like'></span>7
				-->
				<div class="clear"></div>
		<br><br/>
...
<?php $i = 0; rewind_posts(); ?>
	...
	<div class="clear"></div>
				...
				<div class="row">                
                <div class="span3">
                    <div id="pullout-widget-3" class="widget-title">
						<!--Social Login-->
						<div class="widget">
						<h4>ΣΥΝΔΕΘΕΙΤΕ ΜΕ:</h4>			
						...
						<!--End of Social Login--> </div>
					</div>
                
				</div>
				<!--end of pullout widget-->
...
<!--End of Reveal.js-->
<!-- BEGIN: PullOut Widget Settings (should be loaded before pullouts.js) -->
<script type='text/javascript' src='my-pullout-widgets.js'></script>
<!-- END: PullOut Widget Settings -->
<!-- BEGIN: REQUIRED PULLOUTS Scripts -->
    ...
    <script type='text/javascript' src='pullouts/js/lib/jquery.min.js'></script>
    <!-- if you already have jQuery UI 1.8 or later, you don't have to load jquery-ui.min.js -->
    <script type='text/javascript' src='pullouts/js/lib/jquery-ui.min.js'></script>    
...
<!-- Below is my custom stuff that makes this DEMO page work -->
    ...
    <script type='text/javascript' src='demo.js.php'></script>
